        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body border-top pro-det-edit collapse show" id="pro-det-edit-1">
                    <form>
                        {{--  @foreach($prolongation->autorisation->cadidats as$prolongation->autorisation->candidat)  --}}
                        @if($prolongation->autorisation->candidat->photo)
                        <img class="img-radius" style="height: 60px" src="{{ asset('photo/'.$prolongation->autorisation->candidat->photo) }}" alt="User-Profile-Image">
                        @endif
                        <div class="form-group row">
                            <label class="col-sm-6 col-form-label font-weight-bolder">Prenom Nom</label>
                            <div class="col-sm-6">
                                {{$prolongation->autorisation->candidat->prenom }} {{$prolongation->autorisation->candidat->nom }}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-6 col-form-label font-weight-bolder">Date et Lieu  Naissance</label>
                            <div class="col-sm-6">
                                {{  Carbon\Carbon::parse($prolongation->autorisation->candidat->datenaiss)->format('d-m-Y') }}   à {{$prolongation->autorisation->candidat->lieunaiss }}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-6 col-form-label font-weight-bolder">Email</label>
                            <div class="col-sm-6">
                                {{$prolongation->autorisation->candidat->email }}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-6 col-form-label font-weight-bolder">Téléphone</label>
                            <div class="col-sm-6">
                                {{$prolongation->autorisation->candidat->tel }}
                            </div>
                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" value="{{$prolongation->autorisation->candidat->id }}" name="candidat_id">
            ...
            <div class="col-sm-6">
                <div class="card">
                    ...
                    <div class="card-body border-top pro-dont-edit collapse show" id="pro-dont-edit-1">
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    {{ $prolongation->autorisation->fonction  }}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-6 col-form-label font-weight-bolder">Service</label>
                                <div class="col-sm-6">
                                    {{ $prolongation->autorisation->service->nom }}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-6 col-form-label font-weight-bolder">Date début</label>
                                <div class="col-sm-6">
                                    {{  Carbon\Carbon::parse($prolongation->autorisation->datedebut)->format('d-m-Y') }}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-6 col-form-label font-weight-bolder">Date Fin</label>
                                <div class="col-sm-6">
                                    {{  Carbon\Carbon::parse($prolongation->autorisation->datefin)->format('d-m-Y') }}
                                </div>
                            </div>
                            <div class="form-group row">
                                <laubel class="col-sm-6 col-form-label font-weight-bolder">Durée</laubel>
                                <div class="col-sm-6">
                                    {{ $prolongation->autorisation->duree }} mois
                                </div>
                            </div>
                        </form>
                        <hr>
                        <h5 class="mb-0">Prolongation</h5>
                        <form>
                            <div class="form-group row">
                    ...
                    <a  class="btn btn-primary" href="{{ route('prolonger.by.id', ['id'=>$prolongation->autorisation->id ,'candidat'=>$prolongation->autorisation->candidat->id]) }}">Prolonger</a>
