    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="btn-group float-right">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ route('typecontrat.create') }}" class="btn btn-primary" role="button" style="color: white;"style="color: white;">Enregistrer typecontrat</a></li>
                                </ol>
                            </div><!-- /.col -->
                        </div>
                    </div>
                ...
                <table id="example1" class="table table-bordered table-responsive-md table-striped text-center">
                    ...
                    @foreach ($typecontrats as $typecontrat)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('typecontrat.edit', $typecontrat->id) }}" role="button" style="color: white;"class="btn btn-primary"><i class="fas fa-edit"></i></a>
