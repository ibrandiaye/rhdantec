    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="btn-group float-right">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ route('mobilite.create') }}" role="button" >ENREGISTRER mobilite</a></li>
                                </ol>
                            </div><!-- /.col -->
                        </div>
                    </div>
                ...
                <table id="datatable" class="table table-bordered table-responsive-md table-striped text-center">
                    ...
                    @foreach ($mobilites as $mobilite)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('mobilite.edit', $mobilite->id) }}" role="button" class="btn btn-primary"><i class="fas fa-edit"></i></a>
