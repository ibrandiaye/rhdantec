    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="btn-group float-right">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ route('responsabilite.create') }}" class="btn btn-primary"  role="button" style="color: white;">Enregistrer responsabilite</a></li>
                                </ol>
                            </div><!-- /.col -->
                        </div>
                    </div>
                ...
                <table id="example1" class="table table-bordered table-responsive-md table-striped text-center">
                    ...
                    @foreach ($responsabilites as $responsabilite)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('responsabilite.edit', $responsabilite->id) }}" role="button" style="color: white;"class="btn btn-primary"><i class="fas fa-edit"></i></a>
