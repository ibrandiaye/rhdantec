    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="btn-group float-right">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ route('employeur.create') }}" role="button" >ENREGISTRER employeur</a></li>
                                </ol>
                            </div><!-- /.col -->
                        </div>
                    </div>
                ...
                <table id="example1" class="table table-bordered table-responsive-md table-striped text-center">
                    ...
                    @foreach ($employeurs as $employeur)
                        <tr>
                            ...
                            <td>{{ $employeur->nom }}</td>
                            <td>
                                <a href="{{ route('employeur.edit', $employeur->id) }}" role="button" class="btn btn-primary"><i class="fas fa-edit"></i></a>
